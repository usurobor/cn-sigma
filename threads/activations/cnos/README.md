# cnos activation home log

Home-to-foreign channel for Sigma-at-cn-sigma → Sigma-at-cnos.
...
Foreign side reads from the inline `Read home directives through cn-sigma@<sha>` cursor recorded in `cnos:.cn-sigma/logs/YYYYMMDD.md`.
