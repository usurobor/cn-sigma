# cnos essay proposal: Coherent LLMs — Measuring Whether Generation Still Belongs to the Whole

**Mode:** `docs-only`
**Target path (proposed):** `cnos:docs/papers/COHERENT-LLMS.md`
...
- Research Agenda (§12) enumerates five directions that map to cnos work items (coherence-aware decoding, coherence memory, coherence benchmarks, coherence routing, coherence deltas as release artifacts).
- Bibliography-shape (Bender et al.; GPT-3; ReAct; Reflexion; Self-Refine; Tree of Thoughts) places it in the academic-adjacent register of papers, not the project-position-from-inside register of adhocs.

## Acceptance criteria

**AC1** — File landed at `cnos:docs/papers/COHERENT-LLMS.md` with essay body verbatim (no content edits).
...
**AC4** — Bidirectional link added: `DUMB-MODELS-SMART-CELLS.md` cross-references this essay as companion (dumb models frames the substrate; this essay frames the measurement instrument); `COHERENT-LLMS.md` cross-references DUMB-MODELS-SMART-CELLS as prerequisite.
...
- Do NOT implement any of the Research Agenda items in this cycle; each is a separate future issue.
...
- TSC canonical spec at cnos (referenced §2, §3, §11 of the essay).
- cnos README + `Dumb Models, Smart Cells` (referenced §1, §6, §10 of the essay).
- cn-sigma adhoc `20260630-agents-need-a-home-doorway-essay.md` (companion posture: where work persists).
